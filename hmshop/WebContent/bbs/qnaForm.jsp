   ...
   <div id="wrap" align="">
      ...
      <form id="go" name="frm" method="post" action="QnaAction">
         ...
         <table>
            <tr>
               <th>아이디</th>
               <td><input id = "idchk" type="text" name="id"> * 필수  <span id="idchkOut"></span></td>
            </tr>
            
            <tr>
               <th>이름</th>
               <td><input id = "namechk" type="text" name="name"> * 필수  <span id="namechkOut"></span></td> 
            </tr>
            <tr>
               <th>비밀번호</th>
               <td><input id = "passchk"type="password" name="pass"> * 필수 (게시물 수정
                  삭제시 필요합니다.) <span id="passchkOut"></span></td>
            </tr>
            <tr>
               <th>제목</th>
               <td><input type="text" size="50" name="title"><input type="checkBox" name="chk">*비밀글</td>
            </tr>
            <tr>
               <th>내용</th>
         ...
         <br>
         <br> <input type="button" onclick="allChk()" value="등록"> <input type="reset"
